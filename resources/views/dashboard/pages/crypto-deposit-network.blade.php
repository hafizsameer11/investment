...
@section('title', 'Core Mining - Select Crypto Network')
...
<div class="crypto-network-page">
    <div class="crypto-network-header">
        ...
        <p class="crypto-network-subtitle">Choose a network to deposit crypto</p>
    </div>
    ...
    <div class="crypto-network-card">
        ...
        <a href="{{ route('deposit.index') }}" class="crypto-cancel-btn">
            Cancel
        </a>
    </div>
</div>
...
<script>
    ...
    document.getElementById('continueBtn').addEventListener('click', function() {
        ...
        window.location.href = `{{ route('deposit.crypto.confirm') }}?method_id=${paymentMethodId}&amount=${amount}&crypto_wallet_id=${selectedWalletId}`;
    });
</script>
@endpush
@endsection
