        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit Mining Plan</h4>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Edit Mining Plan</h4>
                        <p class="text-muted mb-4 font-14">Update the details of the mining plan.</p>

                        <form action="{{ route('admin.mining-plan.update', $plan->id) }}" method="POST" class="">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control" name="tagline" value="{{ old('tagline', $plan->tagline) }}"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control" name="subtitle" value="{{ old('subtitle', $plan->subtitle) }}"
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control" name="icon_class" value="{{ old('icon_class', $plan->icon_class) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="min_investment" value="{{ old('min_investment', $plan->min_investment) }}" required
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="max_investment" value="{{ old('max_investment', $plan->max_investment) }}" required
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="daily_roi_min" value="{{ old('daily_roi_min', $plan->daily_roi_min) }}" required
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="daily_roi_max" value="{{ old('daily_roi_max', $plan->daily_roi_max) }}" required
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="number" step="0.01" class="form-control" name="hourly_rate" value="{{ old('hourly_rate', $plan->hourly_rate) }}"
