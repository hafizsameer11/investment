                ...
                <div class="page-title-box">
                    <div class="btn-group float-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item active">Add Reward Level</li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Add New Reward Level</h4>
                        <p class="text-muted mb-4 font-14">Fill in the details to create a new reward level.</p>

                        <form action="{{ route('admin.reward-level.store') }}" method="POST" class="">
                            @csrf
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select class="form-control" name="icon_color">
                                    ...
                                    <option value="gold" {{ old('icon_color') == 'gold' ? 'selected' : '' }}>Gold</option>
                                    <option value="silver" {{ old('icon_color') == 'silver' ? 'selected' : '' }}>Silver</option>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="number" step="0.01" class="form-control" name="investment_required" value="{{ old('investment_required') }}" required
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="number" step="0.01" class="form-control" name="reward_amount" value="{{ old('reward_amount') }}" required
