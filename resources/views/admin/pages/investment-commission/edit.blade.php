        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit Investment Commission Structure</h4>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-4 font-14">Update the details of the investment commission structure.</p>

                        <form action="{{ route('admin.investment-commission.update', $commission->id) }}" method="POST" class="">
                            @csrf
                            @method('PUT')
