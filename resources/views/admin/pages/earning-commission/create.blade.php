        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Add Earning Commission Structure</h4>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-4 font-14">Fill in the details to create a new earning commission structure.</p>

                        <form action="{{ route('admin.earning-commission.store') }}" method="POST" class="">
                            @csrf
